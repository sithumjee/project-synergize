...
function Navbar() {
  ...
  const links = [
    ...
    { linkName: "Join With Us", handler: handleSignup, type: "button2" },
  ];
    ...
    <>
      {isLoaded && (
        ...
        className={`w-full px-24 flex justify-between items-center py-6 top-0 z-30 transition-all duration-300 ${
          navFixed || userInfo
            ? "fixed bg-gray-200 border-b border-gray-200"  // Fixed: Transparent background
            : "absolute bg-transparent border-transparent"         // Absolute: Gray background
        }`}
        ...
        <div>
          <Link href="/">
            <img
              src={navFixed || userInfo ? "/logo-black.png" : "/logo-white.png"}
              alt="Logo"
          ...
          >
            ...
            />
            <button
              className="bg-gray-500 py-1.5 text-white w-16 flex justify-center items-center"
              onClick={() => {
                setSearchData("");
                  ...
                  >
                    ...
                    {type === "button" && (
                      ...
                      className={`border text-md font-semibold py-1 px-3 rounded-sm ${navFixed
                        ...
                        } hover:bg-white hover:text-black hover:border-white transition-all duration-500`}
                    >
                      {linkName}
                    </button>
                    )}
