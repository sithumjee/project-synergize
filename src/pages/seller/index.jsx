        ...
        <div className="flex min-h-[80vh] my-10 mt-0 px-32 gap-5">
          ...
          <div>
            <div className="grid grid-cols-3 gap-10 w-full">
              <div
                className="shadow-md bg-gray-200 h-max p-10 flex flex-col gap-2 cursor-pointer hover:shadow-xl transition-all duration-300"
              ...
              <div className="shadow-md bg-gray-200 h-max p-10 flex flex-col gap-2 cursor-pointer hover:shadow-xl transition-all duration-300">
